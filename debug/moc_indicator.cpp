...
const QMetaObject indicator::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_indicator.data,
      qt_meta_data_indicator,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *indicator::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, "QGraphicsItem"))
        return static_cast< QGraphicsItem*>(const_cast< indicator*>(this));
